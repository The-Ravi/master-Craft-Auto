...
class Home_public extends MX_Controller
{
    ...
    public function sendEmail($subject = "", $mailMessage = "")
    {
        ...
        $this->email->from(
            "noreply_ar@nipponpaint.co.in",
            "Nippon Master craft"
        );

                $ci->email->bcc('madhu.pomelodigital@gmail.com');       
                $ci->email->bcc('business.leadindia@gmail.com');

        $this->email->to("info.mastercraftggn@nipponpaint.co.in");

        // $this->email->to('sm.sharma8882@gmail.com');
    ...
    public function services($value = "")
    {
        ...
        // Load alt tags just once for alt text (page = 'home_services_img')
        $data["tags"] = $this->Tag_model->get_tags_for_page("home_services_img");
    ...
    public function services_detail($id)
    {
        ...
        $data["tags"] = $this->Tag_model->get_tags_for_page("home_services_details");
