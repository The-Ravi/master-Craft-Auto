...
<html lang="en">
  <head>
    ...
    <title>Transform Your Wheels With Car Detailing | Mastercraft</title>
    <meta name="description" content="Mastercraft is the best auto destination for car detailing, car denting, painting, ceramic coating & much more. Book Today and turn your car into a masterpiece.">
<!-- Meta Pixel Code -->
<script>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active" >
                <div class="secondslider" >
                  <h2>Flawless <span>Colour Match</span>
                  </h2>
                  <p>with precision and technology</p>
                  <div class="strip">
                    <img src="<?php echo base_url(); ?>assets/frontend/images/strip.png">
                  </div>
                  <div class="btnclaim">
              ...
              <div class="col-md-6 d-flex align-items-center justify-content-center flex-wrap relative" >
                ...
                <div class="col-md-6s d-flex align-items-center justify-content-between" >
                  ...
                  <div class="col">
                   ...
                   <div class="block">
                     <img src="<?php echo base_url(); ?>assets/frontend/images/icon3.png">
                ...
                <div class="secondslider" data-aos="fade-down">
                  ...
                  <div class="col-lg-6 m-auto" data-aos="fade-down">
                    <div class="hc-saying__carousel">
                      <div class="hc-saying__carousel__item">
                        ...
                        <div class="hc-saying__carousel__item__card">
                          ...
                          <div class="hc-saying__carousel__item__card--reviewer">
                            <div class="hc-saying__carousel__item__card--reviewer--image">
                              <img src="<?php echo base_url(); ?>assets/frontend/images/w1.png" width="55" height="50">
                            </div>
                          </div>
                        ...
                        <div class="hc-saying__carousel__item__card">
                          ...
                          <div class="hc-saying__carousel__item__card--reviewer">
                            <div class="hc-saying__carousel__item__card--reviewer--image">
                              <img src="<?php echo base_url(); ?>assets/frontend/images/w2.png" width="55" height="55">
                            </div>
                          </div>
                          <div class="hc-saying__carousel__item__card--content">
                        ...
                        <div class="hc-saying__carousel__item__card">
                          ...
                          <div class="hc-saying__carousel__item__card--reviewer">
                            <div class="hc-saying__carousel__item__card--reviewer--image">
                              <img src="<?php echo base_url(); ?>assets/frontend/images/w3.png" width="55" height="55">
                            </div>
                          </div>
                          <div class="hc-saying__carousel__item__card--content">
                      ...
                      <div class="hc-saying__carousel__item__card">
                        ...
                        <div class="hc-saying__carousel__item__card--reviewer">
                          <div class="hc-saying__carousel__item__card--reviewer--image">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/waterbasedpaints.png" width="55" height="55">
                          </div>
                        </div>
                        <div class="hc-saying__carousel__item__card--content">
                          <p class="hc-saying__carousel__item__card--content--text">Water-borne paints </p>
                    ...
                    <div class="hc-saying__carousel__item__card">
                        ...
                        <div class="hc-saying__carousel__item__card--reviewer">
                          <div class="hc-saying__carousel__item__card--reviewer--image">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/LowVOCSolution.png" width="55" height="55">
                          </div>
                        </div>
                        <div class="hc-saying__carousel__item__card--content">
                    ...
                    <div class="hc-saying__carousel__item__card">
                        ...
                        <div class="hc-saying__carousel__item__card--reviewer">
                          <div class="hc-saying__carousel__item__card--reviewer--image">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/NewGenerationPPF.png" width="55" height="55">
                          </div>
                        </div>
                        <div class="hc-saying__carousel__item__card--content">
                    ...
                    <div class="hc-saying__carousel__item__card">
                        ...
                        <div class="hc-saying__carousel__item__card--reviewer">
                          <div class="hc-saying__carousel__item__card--reviewer--image">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/DryWash.png" width="55" height="55">
                          </div>
                        </div>
                        <div class="hc-saying__carousel__item__card--content">
                    ...
                    <div class="hc-saying__carousel__item__card">
                        ...
                        <div class="hc-saying__carousel__item__card--reviewer">
                          <div class="hc-saying__carousel__item__card--reviewer--image">
                            <img src="<?php echo base_url(); ?>assets/frontend/images/CeramicCoating.png" width="55" height="55">
                          </div>
                        </div>
                        <div class="hc-saying__carousel__item__card--content">
            ...
            <div id="carouselExampleControlss" class="carousel slide carousel-fade" data-bs-ride="carousel">
              <div class="carousel-inner"  >
                <div class="carousel-item active" style="background:url(<?php echo base_url(); ?>assets/frontend/images/slider6.jpg);background-size: cover;">
                  ...
                  <div class="service-covermovile" data-aos="fade-up"  data-aos-duration="500"> <img src="<?php echo base_url(); ?>assets/frontend/images/mbjeep1.png" data-aos="fade-up"> </div>
                  ...
                  <div class="service-cover" data-aos="fade-up"  data-aos-duration="500">
                   ...
                   <div class="detailing ">
                     ...
                     <h3 class="tooltips"> Detailing - Exterior & Interior  <div class="circle red"></div>
                   ...
                   <div class="anti-rust">
                     <h3 class="tooltips"> Rust Shield Coating <div class="circle red"></div>
                   ...
                   <div class="carousel-item repairitm" style="background:url(<?php echo base_url(); ?>assets/frontend/images/slider-6.jpg);background-size: cover;">
                    ...
                    <div class="service-covermovile" data-aos="fade-up"  data-aos-duration="500"> <img src="<?php echo base_url(); ?>assets/frontend/images/mbc.png" data-aos="fade-up"> </div>
                    <div class="service-cover" data-aos="fade-up"  data-aos-duration="500"> 
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="#" method="post" id="createbookingOtp" style="display: none;">
                        <br>
                        <h3 class="heading-small" style="font-size: 18px;">Verify Mobile No.</h3>
                        <p>Enter the 6 digit OTP sent to +91-<span class="entered_phone_no">9205114537</span> <br></p>
                        <div class="form-group mb-3">
                            <input type="text" name="otp" class="form-control" id="otp" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="6" title="Please enter OTP" value="" aria-required="true" aria-invalid="false" placeholder="Enter OTP">
                ...
                <div class="col-3">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item mb-2" data-menuanchor="3rdPage">
                      <a href="<?php echo base_url(); ?>aboutus" class="nav-link p-0 ">About Us</a>
                    </li>
                    <li class="nav-item mb-2"  data-menuanchor="six" >
                      <a href="#six" class="nav-link p-0 ">Services</a>
                    </li>
                    <li class="nav-item mb-2" data-menuanchor="seven">
                      <a href="#seven" class="nav-link p-0 ">Book Now</a>
                    </li>
                  </ul>
                </div>
                <div class="col-3 pl-0">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item mb-2">
                      <a class="nav-link p-0 " href="https://g.co/kgs/URFhWZx" target="_blank">Plot No. 84, IDC, Sector 16 Gurgaon</a>
                    </li>
                    <li class="nav-item mb-2">
                    ...
                    <form action="#" method="post" id="createbookingOtpPopup" style="display: none;">
                        ...
                        <div class="form-group mb-3">
                         ...
                         <div class="resend-otp1" style="display: flex;gap:10px;">
                            <span class="resend-otp-text">Resend OTP</span>
                            <span class="resend-otp-link" style="display: none;">
                                <a class="use-ajax" href="javascript:void(0)" id="resend-otp" data-once="ajax" onclick="resendOTPPopup();">Resend OTP</a>
                            </span>:
                            <div id="timer" class="timer">0:59</div>
                        </div>
