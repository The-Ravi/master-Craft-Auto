(function (global, factory) {
  ...
  var ControlSidebar = /*#__PURE__*/ (function () {
      ...
      _proto._isNavbarFixed = function _isNavbarFixed() {
          var $body = $__default["default"]("body");
          return (
              $body.hasClass(CLASS_NAME_NAVBAR_FIXED) || $body.hasClass(CLASS_NAME_NAVBAR_SM_FIXED) || $body.hasClass(CLASS_NAME_NAVBAR_MD_FIXED) || $body.hasClass(CLASS_NAME_NAVBAR_LG_FIXED) || $body.hasClass(CLASS_NAME_NAVBAR_XL_FIXED)
          );
      };
      ...
      _proto._isFooterFixed = function _isFooterFixed() {
          var $body = $__default["default"]("body");
          return (
              $body.hasClass(CLASS_NAME_FOOTER_FIXED) || $body.hasClass(CLASS_NAME_FOOTER_SM_FIXED) || $body.hasClass(CLASS_NAME_FOOTER_MD_FIXED) || $body.hasClass(CLASS_NAME_FOOTER_LG_FIXED) || $body.hasClass(CLASS_NAME_FOOTER_XL_FIXED)
          );
      };
...
/** toggle open/close start **/
function toggleOpen() {
  document.querySelector('#toggleOpen').classList.add('d-none');
  document.querySelector('#toggleClose').classList.remove('d-none');
  sessionStorage.setItem('toggleOpen', 'sidebar-collapse');
}
function toggleClose() {
  document.querySelector('#toggleClose').classList.add('d-none');
  document.querySelector('#toggleOpen').classList.remove('d-none');
  sessionStorage.removeItem('toggleOpen');
}

let toggleOpenValue = sessionStorage.getItem('toggleOpen');

if (toggleOpenValue === 'sidebar-collapse') {
  document.body.classList.remove('sidebar-collapse');
  document.querySelector('#toggleOpen').classList.add('d-none');
  document.querySelector('#toggleClose').classList.remove('d-none');
}
/** toggle open/close end **/
