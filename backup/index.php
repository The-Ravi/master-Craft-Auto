...
<!--  <source src="images/MasterCraft_Countdown.mp4" type="video/mp4">-->
<!--</video>-->
<!--<video class="loader-iconsmobile" width="100%" height="100%"   autoplay muted playsInline>-->
<!--  <source src="images/MasterCraft_Countdownm.mp4" type="video/mp4">-->
<!--</video>-->
  ...
  <polyline class="arrow" fill="none" stroke="#fff" points="1 12,6.5 6.5,12 12"/>
    ...
    <div id="fullpage">
      ...
      <div class="section sixss" id="section5" style="background:url(images/slider-6.jpg);background-size: cover; overflow:hidden" >
        <div class="intro">
            ...
            <div id="carouselExampleControlss" class="carousel slide carousel-fade" data-bs-ride="carousel">
              <div class="carousel-inner"  >
                <div class="carousel-item active" style="background:url(images/slider6.jpg);background-size: cover;">
                  ...
                  <div class="service-covermovile" data-aos="fade-up"  data-aos-duration="500"> <img src="images/mbjeep1.png" data-aos="fade-up"> </div>
                ...
                <div class="col-3">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item mb-2" data-menuanchor="3rdPage">
                      <a href="#3rdPage" class="nav-link p-0 ">About Us</a>
                    </li>
      ...
      $.ajax({
          ...
          success:function(res){
              if(res.status == 200){
                ...
                $("#contact_form").find('.brand_id').val('');
                $("#contact_form").find('.modal_id').val('');
